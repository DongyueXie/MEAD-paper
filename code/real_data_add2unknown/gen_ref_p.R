...
#'@param dirichlet.scales scales for dirichlet
#'@param cases "null","all_diff"
...
set.seed(12345)
generate_ref_p(c(5,20),c("null","all_diff"),celltypes = celltypes,n_bulks = c(86,500,1000),n_refs=11)

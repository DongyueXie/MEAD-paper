...
source('code/simulation/simulation_dist_func.R')

xin = readRDS('data/simulation/xin_ref_sigma9496.rds')
ref = xin$ref
sigma2 = xin$sigma2
set.seed(12345)
simu_out = simu_study(ref,sigma2,p=c(0.5,0.3,0.1,0.1),n_bulk = 50,dirichlet.scale=10,printevery = 1, z_x_var_denom = 5,
                      bulk_nb_theta = 10,
                      cross_plat_bias_gamma_var = 0.3,X_mult=3)
saveRDS(simu_out,file='simu_res_try6_3.rds')
